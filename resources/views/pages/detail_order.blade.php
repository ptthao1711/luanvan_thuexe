<head>
  ...
  background-repeat: no-repeat;"></i>
      ...
      <div class="container"> 
        ...
        <div class="payment-method">  
        <a href="{{route('tuchoi', ['ID_ORDER' => $show->ID_ORDER]) }}" method="post" class="confirm" style="margin-top: 10px;text-align: center; display: block;" >Từ chối</a>
        </div>
        
  
        @elseif($show->ID_TT == 2) 
        <div class="payment-method">  
            <a class="confirm" href="{{ route('hopdong', ['ID_ORDER' => $show->ID_ORDER]) }}">Xem hợp đồng</a>
        </div> 
        @elseif($show->ID_TT == 3) 
        <div class="payment-method">  
            <button class="confirm">Đánh giá người thuê</button>
        </div> 
        @elseif($show->ID_TT == 4) 
        <div class="payment-method">  
            <button class="confirm">Xem đánh giá</button>
        </div> 
