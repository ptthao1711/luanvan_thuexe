  ...
  <div class="row clearfix">
      <div class="col-lg-12">
          <div class="card chat-app">
            ...
            <div class="chat" style="background-image: url('../images/bnchat.png'); background-size: cover; background-repeat: no-repeat;">
              <div class="mess" style="width: 500px;">
